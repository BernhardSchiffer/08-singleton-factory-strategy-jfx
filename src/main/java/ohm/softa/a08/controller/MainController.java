...
public class MainController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		filterChoiceBox.setItems(FXCollections.observableList(Arrays.asList(OpenMensaAPIService.getInstance().getGson().fromJson(new InputStreamReader(getClass().getResourceAsStream("/filters.json")), String[].class))));
		doGetMeals();
	...
	public void doGetMeals() {
		String currentFilter = filterChoiceBox.getSelectionModel().getSelectedItem();
		MealsFilter filter = MealsFilterFactory.getStrategy(currentFilter);
		logger.debug(filter.getClass().toGenericString());
